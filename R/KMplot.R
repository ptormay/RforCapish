...
str <- unique(as.character(KMtest$x))
str <- sort(str)
col.list <- c("red","blue","black","blueviolet","brown","darkorchid")
plot(fit, main="Kaplan-Meier plot", xlab="Time", ylab="Survival Probability", col=col.list, lty=1)
legend("topright", str, col=col.list, lwd=0.5)
